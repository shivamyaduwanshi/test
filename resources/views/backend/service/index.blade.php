...
@section('title') {{__('Service List')}} @endsection

@section('content')
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">{{__('Services')}} ({{$services->total()}})</h3>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 text-right">
        <a href="{{route('backend.create.service')}}" class="btn btn-primary">{{__('Add Service')}}</a>
    </div>
</div>
<br/>
<div class="row">
    <div class="col-lg-12">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    @php $i = $services->perPage() * ($services->currentPage() - 1); @endphp
                    @foreach ($services as $key => $value)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{route('backend.show.service',$value->id)}}" class="btn btn-sm btn-primary">{{__('Info')}}</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                {{ method_field('DELETE') }}
                 ...
                 <p>{{__('Are you sure want to delete this service?')}}</p>
        </div>
